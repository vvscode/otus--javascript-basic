...
- Когда стек полностью освобождается, самая первая задача извлекается из очереди и обрабатывается. (_Обработка задачи - вызов ассоциированной с ней функции с параметрами_).
...
Ключевое слово await допустимо только в асинхронных функциях и на верхнем уровне модулей. В другом контексте вы получите ошибку SyntaxError.
...
Ещё один способ добавить микрозадачу в очередь - использовать [queueMicrotask()](https://developer.mozilla.org/en-US/docs/Web/API/queueMicrotask)
...
- [Асинхронное программирование в однопоточных средах JavaScript](https://habr.com/ru/post/651037/)
