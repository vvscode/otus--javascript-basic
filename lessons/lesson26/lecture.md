...
Примитивные, простые, базовые типы:
...
Для отмены транспиляции в JS [используют `const enums`](https://www.typescriptlang.org/docs/handbook/enums.html#const-enums)
...
- Ключевое различие **типы не наследуются, а интерфейс можно наследовать**
