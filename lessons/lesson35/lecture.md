...
**WebSocket** - протокол, позволяющий устанавливать двунаправленное(дуплексное) соединение между сервером и клиентом. Используется для создания real-time приложений, таких как чаты, мультиплеерные игр и т.д.

<!-- v -->

### Практика. Напишем свой чат с использованием WebSockets.
