...
- [`jest.spy()`](https://jestjs.io/docs/en/jest-object#jestspyonobject-methodname) - для оборачивания в mock-функции существующие методы
...
it("callFn alerts value entered to prompt", () => {
  jest.spy(window, "prompt").returnValue("123");
